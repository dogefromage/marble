import { DefaultFunctionArgs, GeometryConnectionData, GeometryProgramMethod, GeometryS, GNodeTemplateTags, InputOnlyRowT, ObjMap, ProgramTextureVarMapping } from "../../types";
